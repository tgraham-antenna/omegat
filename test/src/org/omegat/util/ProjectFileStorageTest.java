...
public class ProjectFileStorageTest extends TestCase {
    ...
    public void testFarAbsolutePaths() throws Exception {
        ...
        assertTrue(outProjFile.isFile());
        Omegat outOmt = ProjectFileStorage.parseProjectFile(outProjFile);
        assertEquals(srcDir.getPath() + '/', outOmt.getProject().getSourceDir());
        assertEquals(trgDir.getPath() + '/', outOmt.getProject().getTargetDir());
        assertEquals(dictDir.getPath() + '/', outOmt.getProject().getDictionaryDir());
        assertEquals(glosDir.getPath() + '/', outOmt.getProject().getGlossaryDir());
        assertEquals(tmDir.getPath() + '/', outOmt.getProject().getTmDir());
    }
